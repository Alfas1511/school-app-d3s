...
class _HomePageState extends State<HomePage> {
          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildUpdateCard(Icons.payment, "Pending Fee Payment",
                      "Quarterly fee: \$850 due by March 15", "Pay Now"),
                  _buildUpdateCard(Icons.event, "Annual Sports Day",
                      "March 20, 2024 - Registration open", null),
                  _buildUpdateCard(Icons.book, "Mid-term Results",
                      "Mathematics test results available", null),
                ],
              ),
            ),
            ...
            Padding(
              ...
              child: GridView.count(
                ...
                children: [
                  _buildQuickAccess(Icons.access_time, "Attendance", Colors.blue),
                  _buildQuickAccess(Icons.book, "Homework", Colors.green),
                  _buildQuickAccess(Icons.directions_bus, "Transport", Colors.orange),
                  _buildQuickAccess(Icons.payment, "Fees", Colors.purple),
                  _buildQuickAccess(Icons.calendar_month, "Calendar", Colors.teal),
                  _buildQuickAccess(Icons.person, "Profile", Colors.red),
                ],
              ),
            ),
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 10),
                  _buildUpdateCard(Icons.event, "Math Assignment Submitted",
                      "Grade; A+ Great Work", null),
                  _buildUpdateCard(Icons.book, "Science Project Winner",
                      "1st Place in School Science Fair", null),
                ],
              ),
            ),
  ...
  Widget _buildTransportPage() =>
      const Scaffold(body: Center(child: Text("Transport Page")));
  ...
  Widget _buildUpdateCard(
      IconData icon, String title, String subtitle, String? actionText) {
    return Container(
